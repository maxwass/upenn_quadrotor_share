...
#define FIFOPROTOCOL_ACCELEROMETER_PRECISION					12		// hq12
#define FIFOPROTOCOL_MAGNETOMETER_PRECISION						4		// hq4
#define FIFOPROTOCOL_GYROMETER_PRECISION						4		// hq4
...
// decode GYR data: expected values are 16 bits, with FIFOPROTOCOL_GYROMETER_PRECISION
                ...
                uint16_t len, float *x, float *y, float *z)
{
	...
	*x = FIFOPROTOCOL_SFIX16_TO_FLT(FIFOPROTOCOL_FROM_LITTLE_ENDIAN_16(gyr),
	                                FIFOPROTOCOL_GYROMETER_PRECISION);
