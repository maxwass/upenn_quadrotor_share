...
// will clean LP_EN bit if set, and restore its value afterwards
...
// clear SLEEP_REQ bit and set DEEP_SLEEP and LP_EN bits
...
// set SOFT_RST bit and call inv_icm30xxx_wake_up()
...
int inv_icm30xxx_start_m0(struct inv_icm30xxx * s, inv_bool_t debug);
...
int inv_icm30xxx_initiate_dma_transfer(struct inv_icm30xxx * s, uint8_t dma_channel,
...
int inv_icm30xxx_get_scratch_int0_status(struct inv_icm30xxx * s, uint8_t * status);

// return SCRATCH_INT1_STATUS register value
int inv_icm30xxx_get_scratch_int1_status(struct inv_icm30xxx * s, uint8_t * status);

// return SCRATCH_INT2_STATUS register value
int inv_icm30xxx_get_scratch_int2_status(struct inv_icm30xxx * s, uint8_t * status);
