...
int motor::send_motor_data_ns(int force_in, bool CONTROLLER_RUN)
{
...
{
	//if force hasnt changed then dont go through the steps of checking
	//if(ensure_valid_force(force_in) == (this->force)) return -3;
