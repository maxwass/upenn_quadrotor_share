 ...
 *  for ICM30630 chip variant from ICM30xxx family.
 *
...
/** @brief constructor-like function for Icm30631 device
 *
 *  See inv_device_icm30630_init() for arguments description.
 */
...
enum inv_device_icm30670_config_settings {
	INV_DEVICE_ICM30670_CONFIG_FSR
			= INV_SENSOR_CONFIG_CUSTOM + INV_ICM30670_CONFIG_FSR,    /**< configure full-scale range for sensor */
	INV_DEVICE_ICM30670_CONFIG_BW
			= INV_SENSOR_CONFIG_CUSTOM + INV_ICM30670_CONFIG_BW,     /**< configure bandwith for sensor */
	INV_DEVICE_ICM30670_CONFIG_CUSTOM
			= INV_SENSOR_CONFIG_CUSTOM + INV_ICM30670_CONFIG_CUSTOM, /**< configure custom sensor */
	INV_DEVICE_ICM30670_CONFIG_MAX
};

/** @brief Configure a sensor
 *
 *  Allowed sensor value for ICM30670 device:
 *  - INV_SENSOR_TYPE_GYROSCOPE:     settings is expected to be @sa enum inv_device_icm30670_config_settings
 *                                   pvalue is expected to to a uint16_t containing of value:
 *                                    - @sa enum inv_icm30670_fsr_gyr
 *                                    - @sa enum inv_icm30670_bw_gyr
 *  - INV_SENSOR_TYPE_ACCELEROMETER: settings is expected to be @sa enum inv_icm30670_config_setting
 *                                   pvalue is expected to to a uint16_t containing of value:
 ...
 *  @param sensor   expected to INV_SENSOR_TYPE_ACCELEROMETER or INV_SENSOR_TYPE_GYROSCOPE
