...
enum inv_sensor_type {
	...
	INV_SENSOR_TYPE_ENERGY_EXPANDITURE           = 45,  /**< Energy Expanditure */
...
enum inv_sensor_bacext_event {
	...
	INV_SENSOR_BACEXT_EVENT_ACT_WALKING_START           = 0x01,
	INV_SENSOR_BACEXT_EVENT_ACT_WALKING_END             = 0x81,
	INV_SENSOR_BACEXT_EVENT_ACT_RUNNING_START           = 0x02,
	INV_SENSOR_BACEXT_EVENT_ACT_RUNNING_END             = 0x82,
	INV_SENSOR_BACEXT_EVENT_ACT_ON_BICYCLE_START        = 0x03,
	INV_SENSOR_BACEXT_EVENT_ACT_ON_BICYCLE_END          = 0x83,
	INV_SENSOR_BACEXT_EVENT_ACT_IN_VEHICLE_SIT_START    = 0x04,
	INV_SENSOR_BACEXT_EVENT_ACT_IN_VEHICLE_SIT_END      = 0x84,
	INV_SENSOR_BACEXT_EVENT_ACT_IN_VEHICLE_STAND_START  = 0x05,
	INV_SENSOR_BACEXT_EVENT_ACT_IN_VEHICLE_STAND_END    = 0x85,
	INV_SENSOR_BACEXT_EVENT_ACT_STILL_SIT_START         = 0x06,
	INV_SENSOR_BACEXT_EVENT_ACT_STILL_SIT_END           = 0x86,
	INV_SENSOR_BACEXT_EVENT_ACT_STILL_STAND_START       = 0x07,
	INV_SENSOR_BACEXT_EVENT_ACT_STILL_STAND_END         = 0x87
};
...
typedef struct inv_sensor_event
{
	...
	union {
		...
		struct {
			int          event;            /**< BAC extented data begin/end event as of 
		...
		struct {
			int          event;            /**< shake data event as of 
			                                    enum inv_sensor_shake_event */
		} shake;
			struct {
			int          event;            /**< doubletap data event as of 
			                                    enum inv_sensor_double_tap_event */
		} doubletap;
		struct {
