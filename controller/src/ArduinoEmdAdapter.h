...
/** @brief Maximum number of bytes allowed per read transaction
 */
#define INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE      (4096)

/** @brief Maximum number of bytes allowed per write transaction
 */
#define INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_WRITE_TRANSACTION_SIZE     (48)
