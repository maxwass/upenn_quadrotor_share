...
enum
{
	...
	REG_FW_ADAPTER_MAX_READ_SIZE_03  = 0x07,
	REG_FW_ADAPTER_MAX_READ_SIZE_02  = 0x08,
	REG_FW_ADAPTER_MAX_READ_SIZE_01  = 0x09,
	REG_FW_ADAPTER_MAX_READ_SIZE_00  = 0x0A,
	REG_FW_ADAPTER_MAX_WRITE_SIZE_03 = 0x0B,
	REG_FW_ADAPTER_MAX_WRITE_SIZE_02 = 0x0C,
	REG_FW_ADAPTER_MAX_WRITE_SIZE_01 = 0x0D,
	REG_FW_ADAPTER_MAX_WRITE_SIZE_00 = 0x0E,
};
...
#if (INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE + BRIDGE_PROTO_HEADER_SIZE) > BRIDGE_MAX_DATA_RCV
#error invalid INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE size is too big (should be <= to BRIDGE_MAX_DATA_RCV - BRIDGE_PROTO_HEADER_SIZE)
#endif
	...
	while (readEnd == false)
	{
		switch (currentRegAddr)
		{
			...
			case REG_FW_NOT_USED_2 :
				data[len++] = 0;
				break;
			case REG_FW_ADAPTER_MAX_READ_SIZE_03 :
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE >> 24) & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_READ_SIZE_02 :
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE >> 16) & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_READ_SIZE_01 :		
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE >> 8) & 0xFF);
				break;			
			case REG_FW_ADAPTER_MAX_READ_SIZE_00 :
				data[len++] = (INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_READ_TRANSACTION_SIZE & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_WRITE_SIZE_03 :
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_WRITE_TRANSACTION_SIZE >> 24) & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_WRITE_SIZE_02 :
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_WRITE_TRANSACTION_SIZE >> 16) & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_WRITE_SIZE_01 :
				data[len++] = ((INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_WRITE_TRANSACTION_SIZE >> 8) & 0xFF);
				break;
			case REG_FW_ADAPTER_MAX_WRITE_SIZE_00 :
				data[len++] = (INV_ARDUINO_EMD_ADAPTER_SERIF_MAX_WRITE_TRANSACTION_SIZE & 0xFF);
